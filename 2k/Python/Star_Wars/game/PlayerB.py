...
class PlayerB(sprite.Sprite):
    def __init__(self, x, y):
        sprite.Sprite.__init__(self)

        self.image_u = image.load("sprites/blue-u.png")
        self.image_r = image.load("sprites/blue-r.png")
        self.image_l = image.load("sprites/blue-l.png")
        self.image_d = image.load("sprites/blue-d.png")
    ...
    def update(self, dx, dy, direction=None):
